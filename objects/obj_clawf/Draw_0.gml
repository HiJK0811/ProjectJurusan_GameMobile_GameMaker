...
// --- DRAW BEST MOVES ---
if (jumlah_box_target >= 3) {
    var _diff = jumlah_box_target - 3; 
    var _best = global.best_moves_hanoi[_diff];

    // This check MUST be inside the brackets so it only runs when _best exists!
    if (_best != -1) { 
        draw_set_color(c_aqua);
        draw_text(20, 40, "Best: " + string(_best));
